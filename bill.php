...
?>  
    ...
    <div class="certificate-container">  
        ...
        <img src="../images/bill_with_text.png" alt="ใบเซอร์">  
        <a class="btn btn-primary download-button" href="../images/bill_with_text.png" download="ใบเซอร์.png" onclick="redirectAfterDownload()">ดาวน์โหลดใบเซอร์</a>  
    </div>  
</body>  
</html>
